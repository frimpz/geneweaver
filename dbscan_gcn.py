...
parser.add_argument('--saved-model', type=str, default='models/gcn', help='Saved model')
...
dbs_labels = db_scan(data, 0.1, 5, model_name="models/db_gcn_model.pkl")
...
writer = pd.ExcelWriter('results/dbs_gcn.xlsx')
